var pins_config = {
  "pins":[
  {
    ...
    "hover": "<b><u>SPRINGFIELD</u></b><br>Write any text and load images<br><img src='example.png'>",//info of the popup
    "pos_X": 211,//check the X, Y coordinates guide in the documentation
    "pos_Y": 348,
    "size": 22,//size of the pin
  ...
  {
    "shape": "circle",
    "hover": "<b><u>CHICAGO</u></b><br><span style='color: #bcbcbc;'>Street Address:</span><br>&nbsp;321 Example, Address 54321<br><span style='color: #bcbcbc;'>Telephone:</span><br>&nbsp;(256) 555-4321 / (256) 555-1234",
    "pos_X": 411,
    "pos_Y": 102,
    "size": 22,
    "outline": "#660000",
  ...
  {
    "shape": "circle",
    "hover": "<b><u>PEORIA</u></b><br><span style='color: #999;'>Click to open a modal window!</span><br><span style='color: #ff6666;'><b>Modal Window Option is Compatible<br> with Bootstrap Only.</b></span>",
    "pos_X": 205,
    "pos_Y": 238,
    "size": 18,
    "outline": "#660000",
...
jQuery(function () {
  ...
  if(pins_len > 0) {
    ...
    var tsvg_obj = document.getElementById("usiljspins");
    ...
    for (var i = 0; i < pins_len; i++) {
      if (pins_config.pins[i].shape === "circle") {
        ...
        svg_circle.setAttributeNS(null, "id", "usiljspins_" + i);
        tsvg_obj.appendChild(svg_circle);
        usiljsAddEvent(i);
      }
        ...
        svg_rect.setAttributeNS(null, "id", "usiljspins_" + i);
        tsvg_obj.appendChild(svg_rect);
        usiljsAddEvent(i);
      }
    }
...
function usiljsAddEvent(id) {
  var obj = jQuery("#usiljspins_" + id);
  if(pins_config.pins[id].active === true){
    obj.attr({"cursor": "pointer"});
    obj.hover(function () {
      jQuery("#usiljstip").show().html(pins_config.pins[id].hover);
